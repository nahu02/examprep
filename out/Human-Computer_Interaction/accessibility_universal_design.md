# Universal Usability & Accessibility: Revision Notes
...
3. Obtain accurate statistics on user population characteristics
4. Sample representative individuals and user groups proportionally
5. Apply inclusive design methods and toolkits to accommodate a wide range of abilities
...
5. Motor or physical impairment
...
3. **Legal requirement**: Many jurisdictions mandate accessibility (e.g., ADA, Section 508 of the Rehabilitation Act)
4. **Universal benefit**: Accessibility improvements benefit all users (universal design/design for all)
...
- **Symbol/picture-based interfaces** for illiterate AAC users (augmentative and alternative communication)
- **Text entry with prediction tools** for literate AAC users to increase entry rate
...
1. **Multiple-choice**: Distinguish between accessibility, usability, and universal usability; identify disability categories; recognize design approaches (ability-based vs. inclusive design)

2. **Essay questions** (likely 6-point format):
   - Explain the relationship between accessibility and usability, and why both matter in HCI
   - Describe the "curb-cut argument" and how it justifies universal design
   - Analyze a design scenario (e.g., vending machine for users with neurological challenges, sight limitations, or mobility impairments) and propose five design considerations per group
   - Compare ability-based design and inclusive design as approaches to accessibility

**Example question (essay):**
*"Explain why accessibility differs from usability. Use the curb-cut argument to illustrate how accessibility improvements benefit all users. Then, describe two design approaches (ability-based design and inclusive design) and explain when each is most appropriate."*

**Brief answer summary**: Accessibility focuses on the match between user abilities and system requirements (especially for people with disabilities), while usability concerns general effectiveness and satisfaction. The curb-cut argument shows that ramps benefit wheelchair users, parents with strollers, and delivery workers—demonstrating universal benefit. Ability-based design tailors solutions to specific user groups through co-design; inclusive design uses systematic toolkits and population statistics to accommodate a broad spectrum of users.
